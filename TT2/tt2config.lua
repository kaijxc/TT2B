...
Icon = {    
    ...
    damonDark = Pixels.new({{5456668,0,0}, {5459227,0,86}, {5456668,86,0}, {5459228,86,86}}, nil),
    finnDark  = Pixels.new({{5456926,0,0}, {5457437,0,86}, {1285,86,86}, {5456147,86,0}}, nil),
    nohniDark = Pixels.new({{3687757,0,0}, {4410705,0,86}, {4476242,86,86}, {3687757,86,0}}, nil),

    damon = Pixels.new({{16763733,0,0}, {16771668,0,86}, {16771669,86,86}, {16763734,86,0}}, nil),
    finn  = Pixels.new({{16764763,0,0}, {16766040,0,86}, {3854,86,86}, {16762428,86,0}}, nil),
    nohni = Pixels.new({{11391980,0,0}, {13625850,0,86}, {13757436,86,86}, {11391981,86,0}}, nil)
}